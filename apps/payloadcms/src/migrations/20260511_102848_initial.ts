...
export async function up({ db, payload, req }: MigrateUpArgs): Promise<void> {
  ...
  CREATE TABLE "portfolio_items_tags" (
  	"_order" integer NOT NULL,
  	"_parent_id" integer NOT NULL,
  	"id" varchar PRIMARY KEY NOT NULL,
  ...
  ALTER TABLE "portfolio_items_images" ADD CONSTRAINT "portfolio_items_images_image_id_media_id_fk" FOREIGN KEY ("image_id") REFERENCES "public"."media"("id") ON DELETE set null ON UPDATE no action;
  ALTER TABLE "portfolio_items_images" ADD CONSTRAINT "portfolio_items_images_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."portfolio_items"("id") ON DELETE cascade ON UPDATE no action;
  ALTER TABLE "portfolio_items_tags" ADD CONSTRAINT "portfolio_items_tags_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."portfolio_items"("id") ON DELETE cascade ON UPDATE no action;
  ...
  CREATE INDEX "portfolio_items_images_order_idx" ON "portfolio_items_images" USING btree ("_order");
  CREATE INDEX "portfolio_items_images_parent_id_idx" ON "portfolio_items_images" USING btree ("_parent_id");
  CREATE INDEX "portfolio_items_images_image_idx" ON "portfolio_items_images" USING btree ("image_id");
  CREATE INDEX "portfolio_items_tags_order_idx" ON "portfolio_items_tags" USING btree ("_order");
  CREATE INDEX "portfolio_items_tags_parent_id_idx" ON "portfolio_items_tags" USING btree ("_parent_id");
...
export async function down({ db, payload, req }: MigrateDownArgs): Promise<void> {
  ...
  DROP TABLE "portfolio_items_images" CASCADE;
  DROP TABLE "portfolio_items_tags" CASCADE;
